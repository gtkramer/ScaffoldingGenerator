...
public partial class StlAsciiLexer : Lexer {
	...
	public static readonly string[] ruleNames = {
		"SOLID_BEGIN", "SOLID_END", "FACET_BEGIN", "FACET_END", "LOOP_BEGIN", 
	...
	private static char[] _serializedATN = {
		...
		'\n', '\n', '\r', '\n', '\xE', '\n', '[', '\x3', '\v', '\x5', '\v', '_', 
		'\n', '\v', '\x3', '\v', '\a', '\v', '\x62', '\n', '\v', '\f', '\v', '\xE', 
		'\v', '\x65', '\v', '\v', '\x3', '\v', '\x5', '\v', 'h', '\n', '\v', '\x3', 
		'\v', '\x6', '\v', 'k', '\n', '\v', '\r', '\v', '\xE', '\v', 'l', '\x3', 
		'\f', '\x5', '\f', 'p', '\n', '\f', '\x3', '\f', '\x3', '\f', '\x6', '\f', 
		't', '\n', '\f', '\r', '\f', '\xE', '\f', 'u', '\x3', '\f', '\x3', '\f', 
		'\x2', '\x2', '\r', '\x3', '\x3', '\x5', '\x4', '\a', '\x5', '\t', '\x6', 
		'\v', '\a', '\r', '\b', '\xF', '\t', '\x11', '\n', '\x13', '\v', '\x15', 
		'\f', '\x17', '\r', '\x3', '\x2', '\x6', '\a', '\x2', '/', '/', '\x32', 
		';', '\x43', '\\', '\x61', '\x61', '\x63', '|', '\x4', '\x2', '-', '-', 
		'/', '/', '\x3', '\x2', '\x32', ';', '\x5', '\x2', '\v', '\v', '\xE', 
		'\xE', '\"', '\"', '\x2', '\x80', '\x2', '\x3', '\x3', '\x2', '\x2', '\x2', 
		...
		'\v', '\x37', '\x3', '\x2', '\x2', '\x2', '\r', '\x42', '\x3', '\x2', 
		'\x2', '\x2', '\xF', 'J', '\x3', '\x2', '\x2', '\x2', '\x11', 'Q', '\x3', 
		'\x2', '\x2', '\x2', '\x13', 'Y', '\x3', '\x2', '\x2', '\x2', '\x15', 
		'^', '\x3', '\x2', '\x2', '\x2', '\x17', 's', '\x3', '\x2', '\x2', '\x2', 
		'\x19', '\x1A', '\a', 'u', '\x2', '\x2', '\x1A', '\x1B', '\a', 'q', '\x2', 
		'\x2', '\x1B', '\x1C', '\a', 'n', '\x2', '\x2', '\x1C', '\x1D', '\a', 
		'k', '\x2', '\x2', '\x1D', '\x1E', '\a', '\x66', '\x2', '\x2', '\x1E', 
		'\x4', '\x3', '\x2', '\x2', '\x2', '\x1F', ' ', '\a', 'g', '\x2', '\x2', 
		' ', '!', '\a', 'p', '\x2', '\x2', '!', '\"', '\a', '\x66', '\x2', '\x2', 
		'\"', '#', '\a', 'u', '\x2', '\x2', '#', '$', '\a', 'q', '\x2', '\x2', 
		'$', '%', '\a', 'n', '\x2', '\x2', '%', '&', '\a', 'k', '\x2', '\x2', 
		'&', '\'', '\a', '\x66', '\x2', '\x2', '\'', '\x6', '\x3', '\x2', '\x2', 
		'\x2', '(', ')', '\a', 'h', '\x2', '\x2', ')', '*', '\a', '\x63', '\x2', 
		'\x2', '*', '+', '\a', '\x65', '\x2', '\x2', '+', ',', '\a', 'g', '\x2', 
		'\x2', ',', '-', '\a', 'v', '\x2', '\x2', '-', '\b', '\x3', '\x2', '\x2', 
		'\x2', '.', '/', '\a', 'g', '\x2', '\x2', '/', '\x30', '\a', 'p', '\x2', 
		'\x2', '\x30', '\x31', '\a', '\x66', '\x2', '\x2', '\x31', '\x32', '\a', 
		'h', '\x2', '\x2', '\x32', '\x33', '\a', '\x63', '\x2', '\x2', '\x33', 
		'\x34', '\a', '\x65', '\x2', '\x2', '\x34', '\x35', '\a', 'g', '\x2', 
		'\x2', '\x35', '\x36', '\a', 'v', '\x2', '\x2', '\x36', '\n', '\x3', '\x2', 
		'\x2', '\x2', '\x37', '\x38', '\a', 'q', '\x2', '\x2', '\x38', '\x39', 
		'\a', 'w', '\x2', '\x2', '\x39', ':', '\a', 'v', '\x2', '\x2', ':', ';', 
		'\a', 'g', '\x2', '\x2', ';', '<', '\a', 't', '\x2', '\x2', '<', '=', 
		'\a', '\"', '\x2', '\x2', '=', '>', '\a', 'n', '\x2', '\x2', '>', '?', 
		'\a', 'q', '\x2', '\x2', '?', '@', '\a', 'q', '\x2', '\x2', '@', '\x41', 
		'\a', 'r', '\x2', '\x2', '\x41', '\f', '\x3', '\x2', '\x2', '\x2', '\x42', 
		'\x43', '\a', 'g', '\x2', '\x2', '\x43', '\x44', '\a', 'p', '\x2', '\x2', 
		'\x44', '\x45', '\a', '\x66', '\x2', '\x2', '\x45', '\x46', '\a', 'n', 
		'\x2', '\x2', '\x46', 'G', '\a', 'q', '\x2', '\x2', 'G', 'H', '\a', 'q', 
		'\x2', '\x2', 'H', 'I', '\a', 'r', '\x2', '\x2', 'I', '\xE', '\x3', '\x2', 
		'\x2', '\x2', 'J', 'K', '\a', 'p', '\x2', '\x2', 'K', 'L', '\a', 'q', 
		'\x2', '\x2', 'L', 'M', '\a', 't', '\x2', '\x2', 'M', 'N', '\a', 'o', 
		'\x2', '\x2', 'N', 'O', '\a', '\x63', '\x2', '\x2', 'O', 'P', '\a', 'n', 
		'\x2', '\x2', 'P', '\x10', '\x3', '\x2', '\x2', '\x2', 'Q', 'R', '\a', 
		'x', '\x2', '\x2', 'R', 'S', '\a', 'g', '\x2', '\x2', 'S', 'T', '\a', 
		't', '\x2', '\x2', 'T', 'U', '\a', 'v', '\x2', '\x2', 'U', 'V', '\a', 
		'g', '\x2', '\x2', 'V', 'W', '\a', 'z', '\x2', '\x2', 'W', '\x12', '\x3', 
